...
export default function GoogleAuthTest() {
  const { signInWithGoogle, signOut, user, userData, isLoading } = useAuthStore();
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-medium">{userData?.displayName || "Anonymous User"}</p>
            ...
            <div className="py-4 text-center">
              <p className="mb-4 text-muted-foreground">You are not signed in</p>
              <Button
                variant="outline"
